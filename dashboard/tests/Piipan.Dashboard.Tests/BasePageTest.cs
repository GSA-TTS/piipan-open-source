...
namespace Piipan.Dashboard.Tests
{
    public class BasePageTest
    {
        ...
        public IServiceProvider serviceProviderMock(Action<ISetup<IStatesApi, Task<StatesInfoResponse>>> statesInfoResponseOverride = null)
        {
            ...
            locationProviderMock.Setup(c => c.GetStates(It.IsAny<string>())).ReturnsAsync(new string[] { "EA" });
        ...
        {
            return ViewRenderer.SetupRenderingApi("src/Piipan.Dashboard/Pages", typeof(BasePageTest).Assembly.GetName().Name);
        }
    }
}

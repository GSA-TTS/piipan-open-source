...
run_deploy () {
  ...
  support_tools_function_apps=($(get_resources ${SUPPORT_TOOLS_API_TAG} "$RESOURCE_GROUP"))

  for app in "${support_tools_function_apps[@]}"
  do
    echo "Publish ${app} to Azure Environment ${azure_env}"
    pushd ./src/Piipan.SupportTools.Func.Api
